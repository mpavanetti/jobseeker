...
if (! empty($_SERVER['HTTP_X_FORWARDED_PROTO'])) {
	...
	if (in_array($forwarded_protocol, array('http', 'https'), TRUE)) {
...
$config['csrf_exclude_uris'] = array('jenkins/proxy', 'connector-runtime', 'spark-runtime/trigger', 'spark-runtime/cancel/[0-9]+');
