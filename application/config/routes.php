...
$route['dataset-generator'] = 'DatasetGenerator/index';
$route['dataset-generator/create'] = 'DatasetGenerator/create';
$route['dataset-generator/delete'] = 'DatasetGenerator/delete';
...
$route['hop/server-status'] = "Hop/serverStatusJson";
$route['hop/executions'] = "Hop/executions";
$route['hop/execution-log'] = "Hop/executionLog";
$route['hop/graph'] = "Hop/graph";
$route['hop/connections'] = "Hop/connections";
$route['hop/publish-connections'] = "Hop/publishConnections";
$route['hop/import-execution'] = "Hop/importExecution";
$route['hop/download'] = "Hop/download";
$route['hop/delete'] = "Hop/delete";
