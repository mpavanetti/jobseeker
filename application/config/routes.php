...
$route['spark-runtime/trigger'] = "SparkRuntime/trigger";
$route['spark-runtime/status/(:num)'] = "SparkRuntime/status/$1";
$route['spark-runtime/logs/(:num)'] = "SparkRuntime/logs/$1";
$route['spark-runtime/cancel/(:num)'] = "SparkRuntime/cancel/$1";
...
$route['jobCreation/sparkJobOptions'] = "JobCreation/sparkJobOptions";
$route['jobCreation/sparkJob/(:num)'] = "JobCreation/sparkJob/$1";
$route['jobCreation/saveSparkJob'] = "JobCreation/saveSparkJob";
$route['jobCreation/deleteSparkJob'] = "JobCreation/deleteSparkJob";
...
$route['data-engineering/spark-clusters/overview'] = "SparkClusters/overview";
$route['data-engineering/spark-clusters/start'] = "SparkClusters/startCluster";
$route['data-engineering/spark-clusters/stop'] = "SparkClusters/stopCluster";
$route['data-engineering/spark-clusters/restart'] = "SparkClusters/restartCluster";
$route['data-engineering/spark-clusters/notebook'] = "SparkClusters/notebook";
$route['data-engineering/spark-clusters/status/(:num)'] = "SparkClusters/clusterStatus/$1";

$route['data-engineering/spark-jobs'] = "SparkJobs/index";
$route['data-engineering/spark-jobs/activity'] = "SparkJobs/activity";
...
$route['data-engineering/spark-jobs/monitor-by-build'] = "SparkJobs/monitorByBuild";
$route['data-engineering/spark-jobs/capacity'] = "SparkJobs/capacity";
$route['data-engineering/spark-jobs/develop'] = "SparkJobs/develop";
$route['data-engineering/spark-jobs/source/(:num)'] = "SparkJobs/source/$1";
