                    ...
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>userListing" method="POST" id="searchList">
                            <div class="input-group">
                              <input type="text" name="searchText" value="<?php echo html_escape($searchText); ?>" class="form-control input-sm pull-right" style="width: 150px;" placeholder="Search"/>
                  ...
                  <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-danger deleteUser" href="#" data-userid="<?php echo (int) $record->userId; ?>" title="Delete"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                        }
