            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary"> 
                    ...
                    <form role="form" id="InsertDbSettings" action="<?php echo base_url() ?>dbSettings/InsertDbSettings" method="post" role="form">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo set_value('job_name'); ?>" id="job_name" name="job_name" maxlength="50" required autocomplete="off">
                                    </div>
                                </div>
                            ...
                            <div class="row">   
                                  ...
                                  <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control required" id="login" value="<?php echo set_value('login'); ?>" name="login" maxlength="200" autocomplete="off" required>
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="password" class="form-control" id="password" value="<?php echo set_value('password'); ?>" name="password" maxlength="200" autocomplete="off" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="address" class="form-control" id="address" value="<?php echo set_value('address'); ?>" name="address" maxlength="200" autocomplete="off" required>
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="port" value="<?php echo set_value('port'); ?>" name="port" maxlength="200" autocomplete="off" required>
                                    </div>
                                </div> 
                              ...
                              <div class="row">
                                 <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="schema" value="<?php echo set_value('schema'); ?>" name="schema" maxlength="200" autocomplete="off" required>
                                    </div>
                                </div> 
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="value5">Additional Parameters</label>
                                        <input type="text" class="form-control" id="additional_parameters" value="<?php echo set_value('additional_parameters'); ?>" name="additional_parameters" maxlength="200" autocomplete="off">
                                    </div>
                                </div> 
                                </div>
