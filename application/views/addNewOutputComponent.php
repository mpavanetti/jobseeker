<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Add New Output Component</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter the new output component details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form role="form" id="addNewJobInsert" action="<?php echo base_url() ?>JobsTable/addNewOutputComponentInsert" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class ="col-md-6"> 
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="file_name" value="<?php echo set_value('file_name'); ?>" name="file_name" maxlength="128">
                                    </div>
                                </div>
